...
export zw22_mongodb_exe_log="$zw22_path/server/nohup_mongodb.log"

export zw22_pid_python="$zw22_path/server/python.pid"
export zw22_python_exe_log="$zw22_path/server/nohup_python.log"
export zw22_python_py="$zw22_path/server/prisma.py"

export zw22_pid_npm="$zw22_path/server/npm.pid"
export zw22_npm_exe_log="$zw22_path/server/nohup_npm.log"
